...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { bio: @director.bio, birth: @director.birth, fullname: @director.fullname, image: @director.image }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { bio: @director.bio, birth: @director.birth, fullname: @director.fullname, image: @director.image }
    assert_redirected_to director_path(assigns(:director))
  end
