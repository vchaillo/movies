...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { bio: @actor.bio, birth: @actor.birth, fullname: @actor.fullname, image: @actor.image }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { bio: @actor.bio, birth: @actor.birth, fullname: @actor.fullname, image: @actor.image }
    assert_redirected_to actor_path(assigns(:actor))
  end
